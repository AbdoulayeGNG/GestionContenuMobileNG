...
mixin _$ContentModel {
 ...
 int get id; String get title; String? get description; String? get image; String get authorId; String get tags; String get category;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,title,description,image,authorId,tags,category);
...
@useResult
$Res call({
 int id, String title, String? description, String? image, String authorId, String tags, String category
});
...
/// Create a copy of ContentModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? title = null,Object? description = freezed,Object? image = freezed,Object? authorId = null,Object? tags = null,Object? category = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  String title,  String? description,  String? image,  String authorId,  String tags,  String category)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ContentModel() when $default != null:
return $default(_that.id,_that.title,_that.description,_that.image,_that.authorId,_that.tags,_that.category);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  String title,  String? description,  String? image,  String authorId,  String tags,  String category)  $default,) {final _that = this;
switch (_that) {
case _ContentModel():
return $default(_that.id,_that.title,_that.description,_that.image,_that.authorId,_that.tags,_that.category);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  String title,  String? description,  String? image,  String authorId,  String tags,  String category)?  $default,) {final _that = this;
switch (_that) {
case _ContentModel() when $default != null:
return $default(_that.id,_that.title,_that.description,_that.image,_that.authorId,_that.tags,_that.category);case _:
  return null;
...
class _ContentModel implements ContentModel {
  const _ContentModel({required this.id, required this.title, required this.description, required this.image, required this.authorId, required this.tags, required this.category});
...
/// Create a copy of ContentModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? title = null,Object? description = freezed,Object? image = freezed,Object? authorId = null,Object? tags = null,Object? category = null,}) {
